---
title: "Tranformer-based Denoising AutoEncoder (TSDAE)"
categories: [Open-source]
description: "Powerful unsupervised text embedding learning for semantic search in the scenarios of (1) no annotation, (2) domain adaptation and (3) few-shot learning."
repo: https://github.com/UKPLab/sentence-transformers/tree/master/examples/unsupervised_learning/TSDAE
comments: true
---
